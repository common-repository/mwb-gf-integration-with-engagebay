 ...
 */
class Mwb_Gf_Integration_With_Engagebay_Activator {
	...
	public static function activate() {
		...
		self::mwb_eb_gf_create_log_table();
		// Schedule event to clear log.
		self::mwb_eb_gf_scheduled_event();
	 ...
	 * @return void
	 */
	public static function mwb_eb_gf_create_log_table() {
	 ...
	 * @return    void
	 */
	public static function mwb_eb_gf_scheduled_event() {
		$crm_slug = Mwb_Gf_Integration_With_Engagebay::mwb_get_current_crm_property( 'slug' );
